...
pub const CODING_RUST: &str = include_str!("rust.md");
pub const CODING_TYPESCRIPT: &str = include_str!("typescript.md");
pub const CODING_PYTHON: &str = include_str!("python.md");
