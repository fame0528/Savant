...
### Config Mutation (v0.3.5 — Immutable Fields)
...
### BulkManifest (v0.3.5 — 10 agent limit)
...
### ConfigSet (v0.3.5 — Immutable field protection)
...
### SoulMutationPropose (v0.3.5 — 100KB limit)
